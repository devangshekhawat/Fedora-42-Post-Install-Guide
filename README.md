...
* Disable Fedora's Flatpak repository, as we already have the official Flathub one enabled, and having more than one Flatpak repository is unnecessary, and makes installing software more complex.
